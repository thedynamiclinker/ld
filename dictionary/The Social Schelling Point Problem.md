The Social Schelling Point Problem. (noun).

The lack of any [[Social Schelling Point]] within the set of existing brick and mortar businesses.
...
The problem of breaking those walls by introducing some additional dynamic to a social space is what we will call [[Justified Icebreaker]].

Any location that can break those walls becomes a Schelling Point around which others looking to meet people can congregate.

In other words, any business that can solve offer a unique solution to [[Justified Icebreaker|initiation]] can by definition solve the problem of where one can go to meet new people these days.